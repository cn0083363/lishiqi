      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<table width="100%"  cellspacing="1" > 
		 ...
		 <table border="0" cellspacing="0" cellpadding="0" align="left">
           ...
           <table  border="0" cellspacing="0" cellpadding="0" width="100%" align="center "id="btn_group_bottom">
             <tr height="20">
              <td colspan="6"><font class="txt_normal"><B>却下理由</B></font></td>
            </tr>
            <tr>
              <td colspan="4">
	   ...
	   <tr><td><br></td></tr>
						...
						<tr>
							<td	colspan="4">
              <!-- 下のボタングループ 開始 -->
              <form action="${pageContext.request.contextPath }/ResourceConfirmcr" method="post">
			<table  border="0" cellspacing="0" cellpadding="0" width="100%" align="center "id="btn_group_bottom">
                  <!-- <tr><td	colspan="8"	height=5 >&nbsp;</td></tr> -->
    			  <tr><td	colspan="5"	height=5 ></td></tr>
                  <tr align="center">
                      <td width="25%"></td>
                      <td width="25%"><input type="submit" id ="B1" value="    承　認    " class="string"/></td>
                      <td width="25%"></td>
                  </tr>
              </table>
              </form>
